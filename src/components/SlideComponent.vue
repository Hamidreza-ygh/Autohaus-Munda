...
<div  class="relative">
    ...
    <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" @click.prevent="prev">
        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-gray-300/30 dark:bg-gray-800/30 group-hover:bg-gray-500/50 dark:group-hover:bg-gray-800/60 group-focus:ring-2 group-focus:ring-black dark:group-focus:ring-gray-800/70 group-focus:outline-none">
