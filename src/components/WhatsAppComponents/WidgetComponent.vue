<template>
  <div id="wp-widget">
    <div v-if="control" id="whatsapp-chat" class="customHidden">
      ...
      <div class="start-chat">
        ...
        <div class="blanter-msg">
          <textarea
            ...
            v-model="text"
          ></textarea>
          <button id="send-it" class="basis-1/6 flex justify-center items-center" @click="openLink">
...
import img from "../../assets/MundA.png";
export default {
  components: {
    Message,
  },
