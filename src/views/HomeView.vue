<template>
  <div class="bg-red-600 rounded-b-[100px]">
    <div class="z-10 h-[380px] sm:h-[420px] md:h-[520px] bg-fixed bg-contain bg-[right_16rem] sm:bg-[right_bottom_-0rem] lg:bg-right bg-no-repeat flex flex-row rounded-b-[100px]" style="background-image: url('https://www.autohaus-munda.at/images/header-img.png')">
